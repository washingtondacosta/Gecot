...
?>
	...
	<div id="container">
		...
		<div id="busca">
			<b>RELAT&Oacute;RIO DE PEDIDOS DE VENDAS</b>
			<p>
			
			
			<form action="" method="post">

				<label for="idloja"><b>Loja: </b></label> <select id="idloja"
					name="idloja">
    <?php
				
				$instrucaoSQL2 = "select * from loja where status='1' order by cidade";
				$consulta2 = mssql_query ( $instrucaoSQL2 );
				
				while ( $cadaLinha2 = mssql_fetch_array ( $consulta2 ) ) {
					echo '<option value="' . $cadaLinha2 [endereco] . '">' . $cadaLinha2 [cidade] . " - " . $cadaLinha2 [endereco] . '</option>';
				}
				?>
</select>
				<p>

					Per&iacute;odo de:<input type="date" name="DataInicial"> a: <input
						type="date" name="DataFinal">
				
				
				<p>
					<input type="submit" name="enviar" value="Gerar relat&oacute;rio">
